...
import { motion, useMotionValue, useTransform, Transition, MotionValue } from 'motion/react';
      ...
      {item.image && (
        <div className="carousel-item-image-wrapper">
          <img
            ...
            decoding="async"
          />
          <div className="carousel-item-image-overlay" />
        </div>
      )}
...
export default function Carousel({
  ...
  const [containerWidth, setContainerWidth] = useState<number>(baseWidth || 380);
  ...
  const itemWidth = Math.max(260, effectiveWidth - containerPadding * 2);
  ...
  return (
    <div
      ...
      style={{
        ...
        ...(round && { height: baseWidth ? `${baseWidth}px` : `${containerWidth}px`, borderRadius: '50%' })
      }}
    >
      <motion.div
